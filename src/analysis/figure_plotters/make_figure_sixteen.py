...
def make_figure_sixteen():
    ...
    fig.subplots_adjust(hspace=.4, wspace=0.35)

    df_for_SOCSCI = df_for_SOCSCI.sort_index(axis=1)
    df_for_SOCSCI = df_for_SOCSCI.sort_index(axis=0)
    ax1.set_title('A.', loc='left', fontsize=20, y=1.025, x=-.075)
    ...
    cbar_ax = fig.axes[-1]
    cbar_ax.set_title('Number of Pieces of Research', y=.15, x=4, rotation=270, fontsize=14)
    ...
    ax2.set_title('B.', loc='left', fontsize=20, y=1.025, x=-.075)
    ...
    ax3.set_title('C.', loc='left', fontsize=20, y=1.025, x=-.075)
    ...
    cbar_ax = fig.axes[-1]
    cbar_ax.set_title('REF ICS Tags', y=.325, x=4, rotation=270, fontsize=14)
    cbar_solids = cbar_ax.collections[0]
    cbar_solids.set_edgecolor("black")
    ...
    ax4.set_title('D.', loc='left', fontsize=20, y=1.025, x=-.075)
