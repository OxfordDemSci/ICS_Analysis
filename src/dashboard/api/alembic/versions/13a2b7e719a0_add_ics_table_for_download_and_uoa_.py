"""Add ics_table_for_download and UOA adjustments

Revision ID: 13a2b7e719a0
Revises: 50d8905d775b
Create Date: 2023-07-16 15:59:29.797039
...
revision = '13a2b7e719a0'
down_revision = '50d8905d775b'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('funders', sa.String(), nullable=True),
    ...
    sa.Column('uoa', sa.String(), nullable=True),
    sa.Column('summary_of_the_impact_topic', sa.String(), nullable=True),
    sa.Column('cultural', sa.String(), nullable=True),
    sa.Column('economic', sa.String(), nullable=True),
    sa.Column('environmental', sa.String(), nullable=True),
    sa.Column('health', sa.String(), nullable=True),
    sa.Column('legal', sa.String(), nullable=True),
    sa.Column('political', sa.String(), nullable=True),
    sa.Column('societal', sa.String(), nullable=True),
    sa.Column('technological', sa.String(), nullable=True),
    ...
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('assessment_panel', sa.String(length=1), nullable=True),
    sa.Column('assessment_group', sa.String(length=5), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
