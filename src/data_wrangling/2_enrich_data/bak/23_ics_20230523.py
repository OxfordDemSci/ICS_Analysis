...
def clean_countries(ref_countries):
    if pd.isna(ref_countries) or not ref_countries:
        return set()
...
if __name__ == '__main__':
    ...
    # TODO: Many countries still not correctly assigned.
    #  Work through errors generated by the next line and make necessary adjustments to search_add_country()
    ics['Countries_clean'] = ics['Countries'].apply(clean_countries)
